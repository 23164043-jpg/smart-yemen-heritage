...
class AuthService {
  ...
  static String get baseUrl {
    if (kIsWeb) {
      return "http://192.168.8.134:5000/api/users"; // Web
    } else if (Platform.isAndroid) {
      return "http://192.168.8.134:5000/api/users"; // Android Device
    } else {
      return "http://192.168.8.134:5000/api/users"; // iOS, Windows, macOS, Linux
    }
  }
