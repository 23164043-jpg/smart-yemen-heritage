...
class AuthService {
  ...
  static String get baseUrl {
    if (kIsWeb) {
      return "http://localhost:5000/api/users"; // Web
    } else if (Platform.isAndroid) {
      return "http://10.228.82.230:5000/api/users"; // Android Device
    } else {
      return "http://localhost:5000/api/users"; // iOS, Windows, macOS, Linux
    }
  }
